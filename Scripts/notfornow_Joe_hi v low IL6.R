...
emf("J:/My Drive/Nerissa/wholebloodstim/volcplot.emf", width = 6, height = 6)
# Your plot
volc
# Close device
dev.off()
...
RPR <- read.table("Original_data/ReactomePathwaysRelation30112022.txt")
...
ggsave("J:/My Drive/Nerissa/wholebloodstim/pathwayplot.svg", plot = pathwayplot, width = 8, height = 10)

library(devEMF)

emf("J:/My Drive/Nerissa/wholebloodstim/pathwayplot.emf", width = 8, height = 10)
# Your plot
pathwayplot
# Close device
dev.off()
