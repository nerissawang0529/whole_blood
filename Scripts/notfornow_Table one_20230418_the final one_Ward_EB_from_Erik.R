...
##
list_of_patients <- readxl::read_xlsx("Original_data/2304_Present WB stimulation list EB V2.xlsx")
...
studydata_iron <- studydata[,c("EB_id","ethnic_group#White",	
                               "BMI",	
...
export_file_name <- "studydata_iron.csv" 
write.csv(studydata_iron, file.path(destination_folder, export_file_name), row.names = FALSE)
